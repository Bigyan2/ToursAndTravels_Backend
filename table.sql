create table User(User_Id int primary key AUTO_INCREMENT, Username varchar(20) NOT NULL, Email varchar(20) not null, Password varchar(20) not null, Role varchar(10));
...
create table Hotel(HotelId int primary key AUTO_INCREMENT, HotelName varchar(100), HotelLocation varchar(100), HotelImage varchar(255), HotelType varchar(100), HotelDescription text, HotelContact varchar(20));
...
create table CustomPackage(Package_id int primary key AUTO_INCREMENT, User_Id int, TripFrom varchar(100), TripTo varchar(100), DateFrom varchar(100), DateTo varchar(100), Email varchar(100), Children int, Adult int, Phone bigint, FOREIGN KEY (User_Id) REFERENCES User(User_Id));
